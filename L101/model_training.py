...
from tensorflow.python.keras.layers import Input, LSTM, Dense, Attention, CuDNNLSTM, Embedding
...
def build_model_chars(num_chars, lstm_units=256, layers=1, optimiser='adam'):
    ...
    decoder_dense = Dense(num_chars, input_shape=[None, None, lstm_units], activation='softmax',
                          name='softmax_output')
    decoder_output = decoder_dense(atten_output)
...
#train_model_chars("basic1", epochs=50)
